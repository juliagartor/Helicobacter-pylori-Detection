...
## Introduction
The aim of this project is to generate an algorithm capable to detect Helicobacter pylori (a bacteria that is located in the stomach) in biopsy images. To do so, our approach involves the creation of 
